...
let newSeasonSliderObj = document.getElementById("new-season-list");
let newSeasonSliderBuilder = new SliderBuilder(newSeasonSliderObj, 870);
newSeasonSliderBuilder.build();

let newItemsSliderObj = document.getElementById("new-items-list");
let newItemsSliderBuilder = new SliderBuilder(newItemsSliderObj, 1200);
newItemsSliderBuilder.build();

let menu = document.getElementById("menu");
let menuBtn = document.getElementById("menu-btn");
menuBtn.addEventListener("click", () => {
    if(menuBtn.classList.contains("pressed") !== true) {
        menuBtn.classList.remove("unpressed");
        menuBtn.classList.add("pressed");
        menu.classList.add("show");
        document.body.classList.add("hide");
    } else {
        menuBtn.classList.remove("pressed");
        menuBtn.classList.add("unpressed");
